...
class NeriaTools
{
    ...
    public static function getTemplateLabels(): array
    {
        return [
            ...
            'multi_recipient_shipped'        => 'Expédition multi-destinataires',
            ...
            'order_address_updated'          => 'Adresse commande mise à jour',
            ...
            'shipped'                        => 'Expédition',
            'subscription_confirmation'      => 'Confirmation d\'abonnement',
