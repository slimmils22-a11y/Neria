...
<div class="neria-section" id="neria-help-health">
  ...
  {if $health_results}
    {assign var='_checks' value=[
      ...
      'dev_tool_residue' => 'help.health_check_dev_tool_residue',
      'fragile_neriaconfig_usage' => 'help.health_check_fragile_neriaconfig_usage',
      'bare_template_var_keys' => 'help.health_check_bare_template_var_keys',
      ...
      'destructive_actions_post' => 'help.health_check_destructive_actions_post',
      'hardcoded_date_format' => 'help.health_check_hardcoded_date_format',
      'rtl_hardcoded_align' => 'help.health_check_rtl_hardcoded_align',
      'display_price_missing_lang' => 'help.health_check_display_price_missing_lang',
      'hardcoded_decimal_format' => 'help.health_check_hardcoded_decimal_format',
      'chained_str_replace' => 'help.health_check_chained_str_replace',
      'customer_email_shop_scope' => 'help.health_check_customer_email_shop_scope',
      'default_currency_usage' => 'help.health_check_default_currency_usage',
      'upgrade_unique_key_shop_scope' => 'help.health_check_upgrade_unique_key_shop_scope',
      'tpl_request_uri_escape' => 'help.health_check_tpl_request_uri_escape',
      'cron_strict_date_equality' => 'help.health_check_cron_strict_date_equality',
      'cron_loop_try_catch' => 'help.health_check_cron_loop_try_catch',
      'tpl_js_escape_missing' => 'help.health_check_tpl_js_escape_missing',
      'imap_timeout_missing' => 'help.health_check_imap_timeout_missing',
      'oauth_refresh_error_surfaced' => 'help.health_check_oauth_refresh_error_surfaced',
      'queue_status_enum_migrated' => 'help.health_check_queue_status_enum_migrated',
      'known_regressions_guard_freshness' => 'help.health_check_known_regressions_guard_freshness',
      'control_center_defaults_consistency' => 'help.health_check_control_center_defaults_consistency',
      'unescaped_like_metachars' => 'help.health_check_unescaped_like_metachars',
      'template_cat_mapping_complete' => 'help.health_check_template_cat_mapping_complete',
      'php_mysql_clock_mismatch' => 'help.health_check_php_mysql_clock_mismatch',
      'hardcoded_french_text' => 'help.health_check_hardcoded_french_text',
      'orphaned_waitlist_claims' => 'help.health_check_orphaned_waitlist_claims',
      'txt_raw_html_leak' => 'help.health_check_txt_raw_html_leak',
      'alert_email_invalid' => 'help.health_check_alert_email_invalid',
      'stats_snapshot_decryptable' => 'help.health_check_stats_snapshot_decryptable',
      'all_email_crons_disabled' => 'help.health_check_all_email_crons_disabled',
      'behavioral_silence' => 'help.health_check_behavioral_silence',
...
<div class="neria-section" id="neria-help-quickguide">
  ...
  <div class="neria-doc-grid">
    ...
    <div class="neria-doc-card">
      ...
      <a href="{$neria_notice_url|escape:'html':'UTF-8'}" target="_blank" rel="noopener"
