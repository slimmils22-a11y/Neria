<?php
/**
 * P8d (21/09/2026) : pour 73 contrôles du Watchdog (réglages corrompus, crons désactivés, clé de chiffrement absente, webhooks/rebonds/files en
 * échec, seuils de statistiques et de volumes, tests A/B, bons orphelins, fidélité négative, ainsi que 19 analyseurs statiques éprouvés sur un
 * faux module et 10 contrôles de fichiers éprouvés sur les fichiers réels, restaurés), la panne est PROVOQUÉE dans une transaction annulée et le contrôle doit passer de « ok » à l'état
...
function run_test(): array
{
    ...
    neria_assert(is_array($r) && count($r["rows"]) >= 70, "moins de 70 pannes injectées");
