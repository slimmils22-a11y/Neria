...
function run_test(): array
{
    ...
    // Round 360 : 1300→1700 — le verrou scopé par boutique ($this->idShop
    // dans $lockName) a ajouté un commentaire explicatif qui repousse
    // RELEASE_LOCK() plus loin (distance mesurée : 1569 caractères).
    ...
    $helperBody = substr($src, $posHelper, 1700);
    neria_assert(
